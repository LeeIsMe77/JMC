...
var errorLogFileName = "C:\\jmc\\3.7.1.0\\Logs\\Debug Logs\\Error - " + date.toFriendlyDateString() + ".txt";
var socialLogsFileName = "C:\\jmc\\3.7.1.0\\Logs\\Social Logs\\Social - " + date.toFriendlyDateString() + ".txt";
var damageLogFileName = "C:\\jmc\\3.7.1.0\\Logs\\Damage Logs\\Damage - " + date.toFriendlyDateString() + ".txt";
...
function AddMap(mapName, variableName) {
    try{
        ...
        jmc.Parse("#woutput {" + _mapOutputWindow + "}{normal}{ }");
        jmc.Parse("#woutput {" + _mapOutputWindow + "}{red}{Failure adding map: " + caught + "}");
    }
}
...
function ClearMaps(){
    try{
        ...
        jmc.Parse("#woutput {" + _mapOutputWindow + "}{normal}{ }");
        jmc.Parse("#woutput {" + _mapOutputWindow + "}{red}{Failure clearing maps: " + caught + "}");
    }
}
...
function DisplayMap(map){   
    try{     
        ...
        WriteExceptionToStream("Failure displaying map: " + caught);
        jmc.Parse("#woutput {" + _mapOutputWindow + "}{normal}{ }");
        jmc.Parse("#woutput {" + _mapOutputWindow + "}{red}{Failure displaying map: " + caught + "}");
    }    
}
...
function ParseLineForSocial(incomingLine){  
    try{
        ...
        if (matches !== null){        
            ...
            WriteToWindow(_socialOutputWindow, matches[0], color, true);
